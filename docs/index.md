...
**Open problems** include reliable long-horizon planning, inter-agent trust and coordination at scale, cost management for multi-model tiering, and robust evaluation beyond narrow benchmarks.
